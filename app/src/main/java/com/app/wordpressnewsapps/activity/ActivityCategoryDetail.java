...
public class ActivityCategoryDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryId = getIntent().getIntExtra(Constant.EXTRA_ID, 0);
        categoryName = getIntent().getStringExtra(Constant.EXTRA_NAME);
        categorySlug = getIntent().getStringExtra(Constant.EXTRA_SLUG);
    ...
    private void setupToolbar() {
        ...
        ((TextView) findViewById(R.id.toolbar_title)).setText(Html.fromHtml(categoryName));
    ...
    private void setRecyclerViewAdapter() {
        if (restApiProvider.equals(JETPACK)) {
            adapterPostJetpack = new AdapterPostJetpack(ActivityCategoryDetail.this, recyclerView, new ArrayList<>(), sharedPref.getIsShowPostListHeader(), false);
            ...
            adapterPost = new AdapterPost(ActivityCategoryDetail.this, recyclerView, new ArrayList<>(), sharedPref.getIsShowPostListHeader(), false);
    ...
    private void requestPostAPI(final int page_no) {
        if (restApiProvider.equals(JETPACK)) {
            callbackCallJetpack = RestAdapter.createAPI(sharedPref.getRestApiProvider(), sharedPref.getSiteUrl()).getPostsByCategory(page_no, sharedPref.getPostsPerPage(), categorySlug);
            ...
            callbackCall = RestAdapter.createAPI(sharedPref.getRestApiProvider(), sharedPref.getSiteUrl()).getPostsByCategory(categoryId, true, page_no, sharedPref.getPostsPerPage());
