...
public class AdapterCategoryJetpack extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterCategoryJetpack(Context context, RecyclerView view, List<Category> items) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            if (sharedPref.getIsShowPostCountInCategoryList()) {
                vItem.post_count.setText(Tools.numberFormatter(category.post_count) + " " + context.getResources().getString(R.string.title_count_name));
                vItem.post_count.setVisibility(View.VISIBLE);
            } else {
            ...
            if (category.post_count > 0) {
                //vItem.view_category.setVisibility(View.VISIBLE);
            } else {
                //vItem.view_category.setVisibility(View.GONE);
            }
